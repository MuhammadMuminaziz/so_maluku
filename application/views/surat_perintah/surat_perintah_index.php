<div class="contentpanel">
	...
	<div class="panel">
		<div class="panel-heading">
			<h4 class="panel-title">Surat Perintah</h4>
			<p>Daftar surat perintah.</p>
		</div>
								...
								<tr>
									...
									<td>
										<ul class="table-options">
											<li><a href="/surat_perintah/detail/<?php echo $permohonan->id ?>"><i class="fa fa-eye"></i></a></li>
											<?php if ($permohonan->status === PERMOHONAN_DRAFT) : ?>
												<li><a href="/surat_perintah/ubah/<?php echo $permohonan->id ?>"><i class="fa fa-pencil"></i></a></li>
												<li><a href="/surat_perintah/hapus/<?php echo $permohonan->id ?>"><i class="fa fa-trash"></i></a></li>
											<?php endif ?>
										</ul>
									</td>
								</tr>
							<?php elseif ($current_user->level_jabatan == LEVEL_KABIRO && $current_user->id_jabatan == JABATAN_BIRO_ADMIN) : ?>
								<tr>
									...
									<td>
										<ul class="table-options">
											<li><a href="/surat_perintah/detail/<?php echo $permohonan->id ?>"><i class="fa fa-eye"></i></a></li>
											<li><a href="/surat_perintah/spt/<?php echo $permohonan->id ?>">SPT</i></a></li>
											<li><a href="/surat_perintah/sppd_new/<?php echo $permohonan->id ?>">SPPD</i></a></li>
										</ul>
									</td>
								</tr>
							<?php else : ?>
