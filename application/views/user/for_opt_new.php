	...
	<div class="col-md-6">
		<div class="panel">
			<div class="panel-heading nopaddingbottom">
				<h4 class="panel-title">Tambah User OPD Baru</h4>
				...
				<form id="basicForm" action="" class="form-horizontal" method="POST">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							...
							<select id="id_opd" class="select2" name="id_opd" style="width: 100%" data-placeholder="OPD" required disabled>
								<option value="">&nbsp;</option>
								<?php foreach ($list_opd as $opd) : ?>
									<option value="<?= $opd->id ?>" <?= $opd->id == $current_user->id_opd ? 'selected' : '' ?>><?= $opd->nama_opd ?></option>
								<?php endforeach ?>
							</select>
					...
					<div class="row">
						<div class="col-sm-9 col-sm-offset-3">
							...
							<a href="/user/for_opt" class="btn btn-quirk btn-wide btn-default">Kembali</a>
						</div>
					</div>
