	...
	<div class="col-md-6">
		<div class="panel">
			<div class="panel-heading nopaddingbottom">
				<h4 class="panel-title">Tambah User Baru</h4>
			...
			<div class="panel-body">
				...
				<form id="basicForm" action="" class="form-horizontal" method="POST">
					...
					<div class="form-group">
						<label class="col-sm-3 control-label">Pangkat/Golongan <span class="text-danger">*</span></label>
						<div class="col-sm-8">
							<select id="id_pangkat_gol" class="select2" name="id_pangkat_gol" style="width: 100%" data-placeholder="Pangkat/Golongan" required>
								<option value="">&nbsp;</option>
