<div class="contentpanel">
	...
	<div class="panel">
		<div class="panel-heading">
			<h4 class="panel-title">User OPD</h4>
			<p>Daftar User OPD.</p>
		</div>
							...
							<tr>
								...
								<td>
									<ul class="table-options">
										<li><a href="/user/ubah_for_opt/<?php echo $user->id ?>"><i class="fa fa-pencil"></i></a></li>
										<li><a href="/user/hapus_for_opt/<?php echo $user->id ?>"><i class="fa fa-trash"></i></a></li>
									</ul>
								</td>
							</tr>
						<?php endforeach ?>
