				...
				<div class="form-horizontal">
					...
					<div class="row">
						<div class="col-sm-9 col-sm-offset-3">
							<a href="/surat_undangan" class="btn btn-quirk btn-wide btn-default mr5">Kembali</a>
							<?php if ($current_user->level_jabatan == LEVEL_KABIRO && $current_user->id_jabatan == JABATAN_BIRO_UMUM) : ?>
								<?php if ($surat_undangan->status == UNDANGAN_WAITING_NUMBER_BIRO) : ?>
									<form action="/surat_undangan/number_biro" method="POST" style="display: inline-block">
