		...
		<div class="panel-body">
			<?php if ($current_user->level_jabatan == LEVEL_KADIS) : ?>
				<div class="row">
					...
					<div class="col-sm-10">
						<a class="btn btn-success" href="/surat_undangan/new">Tambah</a>
					</div>
				</div>
			<?php endif ?>
								...
								<tr>
									...
									<td>
										<ul class="table-options">
											<li><a href="/surat_undangan/detail/<?php echo $surat_undangan->id ?>"><i class="fa fa-eye"></i></a></li>
											<?php if ($surat_undangan->status === UNDANGAN_DRAFT) : ?>
												<li><a href="/surat_undangan/ubah/<?php echo $surat_undangan->id ?>"><i class="fa fa-pencil"></i></a></li>
												<li><a href="/surat_undangan/hapus/<?php echo $surat_undangan->id ?>"><i class="fa fa-trash"></i></a></li>
											<?php endif ?>
										</ul>
									</td>
								</tr>
