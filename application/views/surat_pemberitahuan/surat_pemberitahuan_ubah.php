			...
			<div class="panel-body">
				...
				<form id="basicForm" action="" class="form-horizontal" method="POST">
					<div class="form-group">
						...
						<div class="col-sm-8">
							<?php echo $surat_pemberitahuan->status ?>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<select id="opdTujuan" name="opdTujuan[]" class="form-control" style="width: 100%" data-placeholder="OPD Tujuan" multiple>
								...
								<?php
								$list_id_opd = array_column($surat_pemberitahuan->list_id_opd, 'id_opd');
								?>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" name="nomor_surat" class="form-control" placeholder="Nomor surat" required value="<?php echo $surat_pemberitahuan->nomor_surat ?>" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<div class="input-group">
								<input type="text" name="tanggal_surat" class="form-control" placeholder="yyyy-mm-dd" id="tanggal_surat" value="<?php echo $surat_pemberitahuan->tanggal_surat ?>">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" name="lampiran" class="form-control" placeholder="Lampiran" required value="<?php echo $surat_pemberitahuan->lampiran ?>" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="text" name="perihal" class="form-control" placeholder="Perihal" required value="<?php echo $surat_pemberitahuan->perihal ?>" />
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<textarea name="isi_surat" rows="5" class="form-control" placeholder="Isi pendahuluan" required><?php echo $surat_pemberitahuan->isi_surat ?></textarea>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<textarea name="list_tembusan" rows="5" class="form-control" placeholder="Tembusan" required><?php echo $surat_pemberitahuan->list_tembusan ?></textarea>
						</div>
					</div>
					...
					<div class="row">
						<div class="col-sm-9 col-sm-offset-3">
							<?php if ($surat_pemberitahuan->status === UNDANGAN_DRAFT) : ?>
							...
							<?php endif ?>
							<a href="/surat_pemberitahuan" class="btn btn-quirk btn-wide btn-default">Kembali</a>
						</div>
					</div>
