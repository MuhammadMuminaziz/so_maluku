		...
		<div class="panel-body">
			<?php if ($current_user->level_jabatan == LEVEL_KADIS) : ?>
				<div class="row">
					...
					<div class="col-sm-10">
						<a class="btn btn-success" href="/surat_pemberitahuan/new">Tambah</a>
					</div>
				</div>
			<?php endif ?>
						...
						<?php foreach ($list_surat_pemberitahuan as $surat_pemberitahuan) : ?>
							<?php if ($current_user->level_jabatan == LEVEL_KADIS) : ?>
								<tr>
									...
									<td>
										<?php if ($surat_pemberitahuan->status == UNDANGAN_APPROVED) : ?>
											<a target="_blank" href="/generated/surat_pemberitahuan/<?php echo $surat_pemberitahuan->doc ?>">Download</i></a>
										<?php else : ?>
									...
									<td>
										<ul class="table-options">
											<li><a href="/surat_pemberitahuan/detail/<?php echo $surat_pemberitahuan->id ?>"><i class="fa fa-eye"></i></a></li>
											<?php if ($surat_pemberitahuan->status === UNDANGAN_DRAFT) : ?>
												<li><a href="/surat_pemberitahuan/ubah/<?php echo $surat_pemberitahuan->id ?>"><i class="fa fa-pencil"></i></a></li>
												<li><a href="/surat_pemberitahuan/hapus/<?php echo $surat_pemberitahuan->id ?>"><i class="fa fa-trash"></i></a></li>
											<?php endif ?>
										</ul>
									</td>
								</tr>
