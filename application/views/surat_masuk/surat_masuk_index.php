						...
						<?php foreach ($list_surat_masuk as $surat_masuk) : ?>
							...
							<?php if ($current_user->level_jabatan == LEVEL_KADIS) : ?>
								<tr>
									...
									<td><a target="_blank" href="/lampiran/<?php echo $surat_masuk->doc_lampiran ?>.pdf">Download</i></a></td>
									<td>
										<a target="_blank" href="/lampiran/<?php echo $surat_masuk->doc_lampiran ?>.pdf">Download</i></a>
									</td>
									<td class="text-right"><?= $surat_masuk->tanggal_surat ?></td>
									<td>
										<ul class="table-options">
											<li><a href="/surat_masuk/detail/<?php echo $surat_masuk->id ?>"><i class="fa fa-eye"></i></a></li>
										</ul>
									</td>
								</tr>
									...
									<td>
										<ul class="table-options">
											...
											<?php if ($surat_masuk->status === MASUK_DRAFT) : ?>
												<li><a href="/surat_masuk/ubah/<?php echo $surat_masuk->id ?>"><i class="fa fa-pencil"></i></a></li>
