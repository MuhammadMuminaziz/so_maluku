<div class="contentpanel">
	<ol class="breadcrumb breadcrumb-quirk">
		...
		<li class="active">Surat Undangan Langsung</li>
	</ol>
	...
	<div class="panel">
		<div class="panel-heading">
			<h4 class="panel-title">Surat Undangan Langsung</h4>
			<p>Daftar surat undangan langsung.</p>
		</div>
		<div class="panel-body">
			<?php if ($current_user->level_jabatan == LEVEL_KADIS) : ?>
				<div class="row">
					...
					<div class="col-sm-10">
						<a class="btn btn-success" href="/surat_undangan_langsung/new">Tambah</a>
					</div>
				</div>
			<?php endif ?>
						...
						<?php foreach ($list_surat_undangan as $surat_undangan) : ?>
							<?php if ($current_user->level_jabatan == LEVEL_KADIS) : ?>
								<tr>
									...
									<td><?= $surat_undangan->nama_opd_from ?></td>
									<td><?= $surat_undangan->nama_opd_to ?></td>
									<td>
										<?php if ($surat_undangan->status == UNDANGAN_LANGSUNG_APPROVED) : ?>
											<a target="_blank" href="/generated/surat_undangan_langsung/<?php echo $surat_undangan->doc ?>">Download</i></a>
										<?php else : ?>
									...
									<td>
										<ul class="table-options">
											<li><a href="/surat_undangan_langsung/detail/<?php echo $surat_undangan->id ?>"><i class="fa fa-eye"></i></a></li>
											<?php if ($surat_undangan->status === UNDANGAN_LANGSUNG_DRAFT) : ?>
												<li><a href="/surat_undangan_langsung/ubah/<?php echo $surat_undangan->id ?>"><i class="fa fa-pencil"></i></a></li>
												<li><a href="/surat_undangan_langsung/hapus/<?php echo $surat_undangan->id ?>"><i class="fa fa-trash"></i></a></li>
											<?php endif ?>
										</ul>
									</td>
								</tr>
