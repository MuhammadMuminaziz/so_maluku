...
class Surat_Masuk extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['list_surat_masuk'] = $this->surat_masuk_model->get_by_current_user_1();
		// var_dump(count($data['list_surat_masuk']));die;
		$data['status'] = $status;

		$this->template->load('templates/admin_template', 'surat_masuk/surat_masuk_index', $data);
	}

	// public function luar_opd()
	// {
	// 	$this->load->model('surat_masuk_model');
