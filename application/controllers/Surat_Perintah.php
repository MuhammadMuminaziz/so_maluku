...
class Surat_Perintah extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->template->load('templates/admin_template', 'surat_perintah/surat_perintah_index', $data);
	}
	...
	public function new()
	{
		...
		$this->template->load('templates/admin_template', 'surat_perintah/surat_perintah_new');
	}
	...
	public function detail($id = null)
	{
		...
		$this->template->load('templates/admin_template', 'surat_perintah/surat_perintah_detail', $data);
	}
	...
	public function ubah($id = null)
	{
		...
		if ($status === PERMOHONAN_DRAFT) {
			$this->template->load('templates/admin_template', 'surat_perintah/surat_perintah_ubah', $data);
		} else {
			redirect('surat_perintah');
		}
	}
