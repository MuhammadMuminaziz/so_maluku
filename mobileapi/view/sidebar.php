    ...
    <div class="data-scrollbar" data-scroll="1">
        <nav class="mm-sidebar-menu">
            <ul id="mm-sidebar-toggle" class="side-menu">
                ...
                <li class="<?= $active === 'admob' ? 'active' : '' ?>">
                    <a href="../view/index.php?page=admob" class="svg-icon">
                        ...
                        </i><span class="">AdMob Configuration</span>
                    </a>
                </li>
                ...
                <?php }?>
                <?php if(isset($value) && isset($value->navigationStyle) && in_array($value->navigationStyle,['sidedrawer','bottom_navigation'])) { ?>
            ...
            <?php } ?>
                ...
                <?php if(isset($value) && isset($value->navigationStyle) && in_array($value->navigationStyle,['tabs'])) { ?>
